...
import { fromSmallestUnits, MINUTE, YEAR } from '../common/lib';
...
export async function getLPTokenInfo(
    ...
    if (poolInfo.asset1 === 0) {
        ...
        const { price } = await dex.getSwapQuote(firstAsset, ALGO_ASSET, BigInt(10 ** firstAsset.decimals), 0.01);
        fstAssetPrice = algoPrice * price;
    }
